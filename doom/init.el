...
(doom! :input
       ...
       (org +gnuplot +pretty +pandoc +noter +dragndrop +present +jupyter)               ; organize your plain life in plain text
       ...
       ;;(qt +lsp
       ;;    +tree-sitter)                ; the 'cutest' gui framework ever
